/**
 * 存储域封装：一个 domain 四张表（connections / grants / catalog / snapshots）。
 * OAuth grant 同步写入本机受限权限 journal，防止多 Host 的整文件
 * last-write-wins 覆盖新轮换 Token；凭证不进入 loader 配置树或日志。
 */
import { defineDomain, domainTable } from '@deepseek-ai/dsh-storage-domain';
import { connectionRecordSchema, connectionSnapshotSchema, governancePolicySchema, grantRecordSchema, catalogRecordSchema } from './schema.js';
