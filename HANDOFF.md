...
3. Release：https://github.com/duhu2000/dsh-mcp-connector/releases/tag/v0.2.8
4. npm：https://www.npmjs.com/package/dsh-mcp-connector
5. npm `latest`：`0.2.8`；发布包共 44 个文件，GitHub OIDC Release（run `32573687417`）与 CI 均通过；本次正式发布有状态 MCP 工具发现修复。
