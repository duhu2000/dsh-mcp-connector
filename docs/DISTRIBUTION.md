...
|---|---|---|---|---|---|---|---|
| [awesome-dsh-plugin](https://awesome-dsh-plugin.com/p/duhu2000/dsh-mcp-connector/) | Curated YAML; manual PR; generated `plugins.json` | Listed and searchable; [initial PR #2633](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/2633) and [description PR #3656](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/3656) merged | Public JSON remains at `0.2.39` while npm is `0.2.41` because the upstream site build is globally blocked by added-date derivation | Correct GitHub/npm installation guidance | Track green, mergeable upstream build fix [PR #4821](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/4821); do not open a duplicate fix | P2 / upstream sync blocked | 2026-09-11 |
| [dshmarket.com](https://dshmarket.com/browse/) / `dsh-market` | Consumes awesome-dsh-plugin | Listed and searchable in the actual DSH Discover UI | Search ranking remains accepted; displayed source metadata can remain at `0.2.39` until the awesome feed rebuilds | Canonical npm install resolves npm `latest` (`0.2.41`) independently of the display snapshot | Recheck after awesome PR #4821 merges and the feed rebuild completes | P1 / search complete, metadata watch | 2026-09-11 |
| [dshfind](https://dshfind.com/plugins/duhu2000/dsh-mcp-connector) | Daily GitHub/npm synchronization with public API | Exact API record present | `0.2.41`; `npm_published=true`; last synchronized 2026-09-11 | Canonical npm install | None; daily automated acceptance only | P2 / current | 2026-09-11 |
...
| [dsh.pub](https://dsh.pub/en/plugins/dsh-mcp-connector/) | Daily `dsh-plugin` Topic auto-analysis; submission flow only accepts new repository/package-path coordinates | Listed through Topic auto-analysis; duplicate [submission PR #74](https://github.com/dsh-pub/dsh-pub/pull/74) was rejected with `already_listed` | Public page remains at `0.2.39` after the 2026-09-11 Topic sync workflow completed successfully | Commit-pinned `npx dshpub add` command | Track [sync Issue #88](https://github.com/dsh-pub/dsh-pub/issues/88); do not resubmit the existing package coordinate | P2 / stale metadata | 2026-09-11 |
...
| [dshbase](https://www.dshbase.com/plugins/dsh-mcp-connector/) | Independent verification directory | Listed | Verification badge remains valid, but the page is stale at `0.2.37` and incorrectly says the package is not published to npm | Canonical npm package exists at `0.2.41` | Track [metadata correction #100](https://github.com/ylwl1997/dshbase/issues/100) while preserving the accepted [verification evidence #96](https://github.com/ylwl1997/dshbase/issues/96) | P1 / verified, metadata correction required | 2026-09-11 |
...
| awesome-dsh-plugin generated feed | [Build fix PR #4821](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/4821) | Green and mergeable; fixes a global `added-date` build failure that freezes `plugins.json` and downstream DSH Market metadata | PR merged, build green, and connector entry advances from `0.2.39` to npm latest |
| dsh.pub metadata refresh | [Sync Issue #88](https://github.com/dsh-pub/dsh-pub/issues/88) | Topic sync workflow succeeded on 2026-09-11 but the live listing remains at `0.2.39` | Public version and commit advance to npm latest/current main without a duplicate submission |
| DSH Plugin Directory | [Submission #226](https://github.com/alexchenzl/dsh-plugin-directory/issues/226) | Accepted and public page currently reports `0.2.41` | Complete; monitor automatically |
| dshbase source metadata | [Metadata correction #100](https://github.com/ylwl1997/dshbase/issues/100) | Verification is accepted in #96; the correction requests removal of the false npm claim and an update from `0.2.37` | Public page reports npm availability and npm latest while retaining the verified/install-tested status |
