...
| Desktop E2E | 0.2.10 实机回归已通过；0.2.11 待授权回归 | 完全重启、中文单语界面、9 张卡片、既有连接/授权无损；八爪鱼完成 OAuth 登录、工具枚举与只读调用 |
...
- 当前发布候选：`0.2.11`，用于八爪鱼标准 OAuth 2.1 + PKCE 动态注册兼容；75 项测试通过，待 npm Trusted Publishing 与 Desktop 真实授权回归。
- 许可证：MIT，公开仓库。
